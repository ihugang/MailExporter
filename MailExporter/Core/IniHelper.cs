...
namespace MailExporter.Core
{
    public static class INIHelper
    {
        ...
        [DllImport("kernel32")]
        private static extern int WritePrivateProfileString(string lpApplicationName, string lpKeyName,
        ...
        {
            string filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, $"{Program.AppName}.ini"); //在当前程序路径创建
